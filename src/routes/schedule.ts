...
router.post('/', authenticateToken, requireRole('HEAD_TEACHER'), async (req: AuthRequest, res) => {
  try {
...
router.put('/:id', authenticateToken, requireRole('HEAD_TEACHER'), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
...
router.delete('/:id', authenticateToken, requireRole('HEAD_TEACHER'), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
